...
import { MapPin, Thermometer, Building2, Shield, Check, ArrowRight } from "lucide-react";
...
export default function SalaInfoPage() {
  ...
  const [temperaturas, setTemperaturas] = useState([
    { id: 1, nome: "Estoque A - Refrigerador Principal", temp: "", faixa: "2°C a 8°C" },
    { id: 2, nome: "Estoque B - Freezer -20°C", temp: "", faixa: "-15°C a -25°C" },
    { id: 3, nome: "Estoque C - Geladeira Auxiliar", temp: "", faixa: "2°C a 8°C" },
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Informe o local exato onde você está realizando o monitoramento
                    </p>
                  </div>
                    ...
                    <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-lg animate-in slide-in-from-top-2 duration-300">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-sm font-medium text-emerald-700">
                          Sala confirmada: <span className="font-semibold">{salaInfo}</span>
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <ul className="text-xs text-blue-700 space-y-1">
                      ...
                      <li>• Verifique se os equipamentos estão funcionando corretamente</li>
                    </ul>
                  </div>
                </div>
                      ...
                      <div className="ml-11 space-y-2">
                        ...
                        {estoque.temp && (
                          <div className={`text-xs px-2 py-1 rounded ${
                            getTemperatureStatus(estoque.temp, estoque.faixa) === 'ok'
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 ml-11">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-xs">
                      {temperaturas.map((est) => (
                        <div key={est.id} className="flex justify-between items-center">
                          <span className="text-gray-600">Estoque {est.id}:</span>
                          <span className={`font-mono px-2 py-1 rounded ${
                            est.temp 
                              ? getTemperatureStatus(est.temp, est.faixa) === 'ok'
